import { updateGalleryAction } from "@/app/dashboard/actions/update";
...
export default async function EditGalleryPage({ params }: Props) {
  ...
  const item = await prisma.galleryImage.findUnique({ where });
  ...
  return (
    <div className="p-6 max-w-3xl mx-auto">
      ...
      <div className="grid gap-6 md:grid-cols-[1fr,16rem]">
        {/* Form */}
        <form
          action={updateGalleryAction.bind(null, slug)}
