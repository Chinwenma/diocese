...
export default function DioceseHistoryPage() {
  return (
    <section className="bg-white px-4 py-16">
      <div className="max-w-5xl mx-auto">
        <div className="text-center mb-10">
          <h1 className="text-3xl md:text-4xl font-bold text-gray-800">A Brief History of the Diocese</h1>
        ...
        <div className="prose prose-gray max-w-none text-justify leading-relaxed tracking-wider">
          ...
          <p><strong>Funtua:</strong> Once an outstation of Zaria, it witnessed its first baptism in 1929. By 1960, it had a church building and resident priest, Fr. Bell, who engaged the Hausa community in evangelization.</p>

          <p><strong>Malumfashi:</strong> Became an outstation in 1958. Land was acquired in 1961 and a mission opened in 1962, led by Fr. Richard Farmer OP. The mission prioritized education and healthcare, managed by Dominican Sisters.</p>

          <p><strong>Katsina:</strong> Initially an outstation of Kano, then Gusau, then Funtua. A residence was built in 1964 but the civil war impacted pastoral presence. Despite this, missionary work spread to Dutsin-Ma, Daura, Kankia, Jibia, and Batsari.</p>

          <h3>Rural Outreach and Evangelization</h3>
          ...
          <ul>
            <li>28 priests</li>
            <li>1 higher institution</li>
            <li>3 secondary schools</li>
            <li>11 nursery and primary schools</li>
            <li>1 health institution (run by Dominican Sisters)</li>
          </ul>
